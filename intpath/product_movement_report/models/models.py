...
class Base(models.AbstractModel):
    ...
    def web_read_group(self, domain, fields, groupby, limit=None, offset=0, orderby=False,
        ...
        if self._name == 'stock.move' and domain:
            ...
            report = self.env['ir.actions.report'].search([('report_name', '=', 'product_movement_report.report_product_moves_custom')])
            report.sudo().write({'context': {'from_date_':from_date, 'to_date_':to_date}})
