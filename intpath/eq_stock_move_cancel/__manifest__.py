...
##############################################################################
{
    ...
    """,
    'summary': """ This Module allows user to cancel done stock move.
        cancel stock move | cancel sale order | cancel delivery order
        | cancel transfer | cancel receipt | cancel incoming shipment
        | cancel adjustment | cancel inventory adjustment | cancel scrap order
        | cancel purchase order | cancel po | cancel so | cancel picking.
    """,
