odoo.define('pos_order_print.showOrder',function(require){
"use strict";
    ...
    models.load_models({
        ...
        fields: ['id', 'name', 'session_id', 'state', 'pos_reference', 'partner_id', 'amount_total','lines', 'amount_tax', 
                'sequence_number', 'fiscal_position_id', 'pricelist_id', 'create_date'],
        domain: function(self){ return [['company_id','=',self.company.id], ['partner_id', '!=', false]]; },
